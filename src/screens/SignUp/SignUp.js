...
export default function SignUp({navigation}) {
  ...
  const handleConfirmPasswordChange = val => {
    if (
      data.password.toLowerCase() === val.toLowerCase() &&
      val.toLowerCase() === data.password.toLowerCase()
    ) {
      setData({
        ...data,
        confirmPassword: val,
    ...
    <ScrollView style={{flex: 1}}>
      <View style={styles.MainView}>
        ...
        <View style={{marginTop: 40}}>
          ...
          <Text style={styles.Sign_up_second_line}>
        ...
        <View style={styles.Animatable_first}>
          ...
          <View style={styles.Input_view}>
            <View style={styles.Input_view_child}>
              ...
              {data.isValidName ? (
                <AntDesign
                  style={styles.Input_view_child_input_icon}
                  name="user"
                  size={20}
                  color="#b3b3b3"
                />
            ...
            <View style={styles.Input_view_child}>
              ...
              {data.isValidConfirmPassword ? (
                ...
                <Animatable.View
                  animation="bounceInRight"
                  duration={1000}
                  style={styles.Animatable_View_icon}>
                  <MaterialIcons
                    style={styles.Input_view_child_input_icon}
                    name="error"
                    size={20}
